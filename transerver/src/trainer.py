...
from src.utils import get_optimizer, get_optimizer_reload
...
class TrainerMT():
    def __init__(self, encoder, decoder, data, params, num_updates):
        ...
        self.optimizer = get_optimizer_reload(self.enc_dec_params, self.params.optim, self.params.reload_model)
